...
class DataTransformation:
    def __init__(self ,filename):
        ...
        self.path = f'data_segregation/training/good_data/{filename}'
    ...
    def change_hypen(self):
        ...
        try:
            ...
            self.logger.log("transformation_logs", "transformation.log", "error", f"Probelm occured during the  data transformation for the Client Data...{error}")
