...
class RawDataValidator:
    ...
    def validate_file_properties(self):
        try: 
            self.logger.log("general_logs", "general.log", "info", "Validation of the Training Data Started..")
            ...
            self.logger.log("general_logs", "general.log", "error", f"Error during the validation of the training data {error}")

        else: 
            self.logger.log("general_logs", "general.log", "info", f"Completed the raw data validation")
