...
def training() :
    if request.method == 'POST' :
     ...
     #   File_Handler.save_file(file_obj, filename, "training")
        ...
        # After the data transformation, we need to save the data to the db.


        # After adding the value from the client file to the table, clean everything.
