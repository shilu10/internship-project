...
class TrainingDataBaseOperations(IDBOperarion): 
    ...
    def __init__(self, column_names, filename, dir_to_save):
        ...
        self.db_connection = DBConnectionContext(TrainingDBConnection(self.filename)) 
        print(self.db_connection, "db_cionnection")
...
class TestingDataBaseOperations(IDBOperarion): 
    ...
    def create_table(self):
        ...
        try :
            ...
            self.logger.log("testing_db_logs", "db.log", "error", f"Error while creating {table_name} in {self.filename} Database")
    ...
    def create_csv(self):
        ...
        try: 
            ...
            self.logger.log("testing_db_logs", "db.log", "error", f"Error during the creation of csv file from the values of the db table")
...
class TestingDBConnection(IDBConnection):
    ...
    def connect(self):
        try :
            self.logger.log("testing_db_logs", "db.log", "info", f"Started the db connection to {self.db_name}")
